    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WishesInfo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WishesInfo_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WishesInfo_Wishes_WishId",
                        column: x => x.WishId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WishesInfo_UserId",
                table: "WishesInfo",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_WishesInfo_WishId",
                table: "WishesInfo",
                column: "WishId");
        }
